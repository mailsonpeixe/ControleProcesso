...
App.config(['$routeProvider', function($routeProvider) {
        ...
        //route for pessoa fisica
        $routeProvider.when('/pessoafisica/new', {
            templateUrl: 'pessoafisica/edit',
            controller: PessoaFisicaController
        }).when('/pessoafisica/list', {
            templateUrl: 'pessoafisica/list',
            controller: PessoaFisicaController
        }).when('/pessoafisica/edit/:car', {
            templateUrl: 'pessoafisica/edit',
            controller: PessoaFisicaController
        });
